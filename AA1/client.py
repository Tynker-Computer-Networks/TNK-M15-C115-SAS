...
def left_board():
    ...
    for box in range(0,10):
        if(box == 0):
            box_label = Label(game_window, font=("Helvetica",box_width), width=2, height=1, borderwidth=4, bg="red")
        else:
...
def right_board():
    ...
    for box in range(0,10):
        if(box == 0):
            box_label = Label(game_window, font=("Helvetica",box_width), width=2, height=1, borderwidth=4, bg="yellow")
        else:
            box_label = Label(game_window, font=("Helvetica",box_width), width=2, height=1, borderwidth=0, bg="white")
...
def roll_dice():
    global player_turn, player_type, roll_button, left_boxes, right_boxes
    dice_choices=['\u2680','\u2681','\u2682','\u2683','\u2684','\u2685']
